...
import com.mycompany.mezameidiaputri.perpustakaanclient.FormBuku;
import com.mycompany.mezameidiaputri.perpustakaanclient.model.Buku;
import com.mycompany.mezameidiaputri.perpustakaanclient.service.BukuService;
...
public class BukuController {
    ...
    public void getBukuId(){
        ...
        Buku buku = (Buku) bukuService.getBuku(id);
        if(buku!=null){
    ...
    public void saveBuku() {
        ...
        buku = (Buku) bukuService.saveBuku(buku);
        if (buku != null) {
